...
<div class="container">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">ระบบยืม-คืนอุปกรณ์</a>
    ...
    <!-- Admin -->
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item <?=$active_lend?>">
              <a class="nav-link" href="lend.php">การจัดการข้อมูลอุปกรณ์กีฬา</a>
            </li>
          <li class="nav-item <?=$active_book?>">
            <a class="nav-link" href="book.php">เพิ่มอุปกรณ์กีฬา</a>
          </li>
          <li class="nav-item <?=$active_admin?>">
            <a class="nav-link" href="logout.php">ออกจากระบบ</a>
          </li>
      ...
      <!-- orther -->
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item <?=$active_lend?>">
              <a class="nav-link" href="lend.php">ข้อมูลอุปกรณ์กีฬาทั้งหมด</a>
            </li>
