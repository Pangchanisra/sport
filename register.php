      ...
      <div class="row">
        ...
        <div class="col-lg-6 text-center">
         ...
         <form class="container" id="needs-validation" novalidate method="post">
           ...
           <div class="row">
             <div class="col-md-6 mb-3">
               <label for="validationServer05">เลขบัตรประชาชน</label>
               <input type="text" class="form-control " id="validationServer05" placeholder="เลขบัตรประชาชน" required name="address">
               <div class="invalid-feedback">
                 กรุณากรอกรหัสบัตร.
               </div>
             </div>
             <div class="col-md-6 mb-3">
               <label for="validationServer06">เบอร์</label>
               <input type="text" class="form-control " id="validationServer06" placeholder="เบอร์" required 
               name="numbe">
               <div class="invalid-feedback">
                 กรุณากรอกเบอร์.
               </div>
